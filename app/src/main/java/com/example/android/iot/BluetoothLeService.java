...
//ADDING READ AND WRITE METHODS TO THE BLUTOOTH LE SERVICE
    ...
    public void readCustomCharacteristic() {
        ...
        BluetoothGattCharacteristic mReadCharacteristic = mCustomService.getCharacteristic(UUID.fromString("ffffffff-ffff-ffff-ffff-fffffffffff1"));
    ...
    public void writeCustomCharacteristic(int value) {
        ...
        /*get the read characteristic from the service*/
        BluetoothGattCharacteristic mWriteCharacteristic = mCustomService.getCharacteristic(UUID.fromString("ffffffff-ffff-ffff-ffff-fffffffffff4"));
